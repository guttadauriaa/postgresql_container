...
openssl req -x509 -new -nodes -key ${BASEDIR}/rootCA.key -sha256 -days 1024 -out ${BASEDIR}/rootCA.crt -subj "/C=BE/ST=Hainaut/L=Mons/O=UMONS/OU=IG/CN=aios-orch-dev-env-CA"
